...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-BluePrint_MiSTer.git"
CORE_NAME=(BluePrint)
...
UPSTREAM_CORE_NAME=(BluePrint)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-BluePrint.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-BluePrint.rbf)
